# (Unofficial) Amazon Selling Partner API client (PHP) - Selling Partner API for Catalog Items
...
```shell
composer require bricre/amazon-selling-partner-sdk-catalog-items
```
...
```php
<?php
use Amz\CatalogItems\ResponseTypes;
