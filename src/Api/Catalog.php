...
use Amz\CatalogItems\Model\GetCatalogItemResponse as GetCatalogItemResponse;
use Amz\CatalogItems\Model\ListCatalogCategoriesResponse as ListCatalogCategoriesResponse;
use Amz\CatalogItems\Model\ListCatalogItemsResponse as ListCatalogItemsResponse;
...
class Catalog extends AbstractAPI
{
    ...
    {
        return $this->client->request('listCatalogItems', 'GET', 'catalog/v0/items',
            [
                'query' => $queries,
            ]
        );
    ...
    {
        return $this->client->request('getCatalogItem', 'GET', "catalog/v0/items/{$asin}",
            [
                'query' => $queries,
            ]
        );
    ...
    {
        return $this->client->request('listCatalogCategories', 'GET', 'catalog/v0/categories',
            [
                'query' => $queries,
            ]
        );
